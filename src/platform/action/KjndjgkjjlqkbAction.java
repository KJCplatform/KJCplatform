...
public class KjndjgkjjlqkbAction extends BaseAction implements ModelDriven<KjndjgkjjlqkbForm>{
	...
	public String update(){
		...
		kjndjgkjjlqkbService.updateKjndjgkjjlqkb(kjndjgkjjlqkbForm,username);
		operateSuccess=true;
		return "update";
	}
	...
	public String add(){
		username=String.valueOf(request.getSession().getAttribute("hhs_user"));
		kjndjgkjjlqkbService.saveObject(kjndjgkjjlqkbForm,username);
		operateSuccess=true;
		return "add";
	}
	   public String showimport() throws Exception{
	        System.out.println(kjndjgkjjlqkbForm.getDj());
	        kjndjgkjjlqkbService.showimportObject(kjndjgkjjlqkbForm.getDj());
	        operateSuccess=true;
	        return "showimport";
	    }
	    ...
	    public String showexport() throws Exception{
	        ...
	        kjndjgkjjlqkbService.showexportObject(kjndjgkjjlqkbForm.getDj());
	        operateSuccess=true;
	        return "showexport";
	    }
}

...
public class Kjjszjcjb2ServiceImpl implements Kjjszjcjb2Service{	
	...
	public List<Kjjszjcjb2Form> findKjjszjcjb2ListWithPage(int pagesize,int pageno,Kjjszjcjb2Form Kjjszjcjb2Form){
		...
		if(pageno == 1){
			formListTemp = 
					Kjjszjcjb2POListToVOList(kjjszjcjb2Dao.findCollectionByConditionNoPage(hqlWhere, params, orderby));
		}
		return formlist;
	...
	public void showImportObject(String filePath) throws Exception {
		...
		for (int i = 1; i < rows; i++) {
			...
			kjjszjcjb2.setZw(sheet.getCell(3, i).getContents());
			kjjszjcjb2.setJszc(sheet.getCell(4, i).getContents());
			kjjszjcjb2.setSszy(sheet.getCell(5, i).getContents());
			kjjszjcjb2.setYjfx(sheet.getCell(6, i).getContents());
			kjjszjcjb2.setSj(sheet.getCell(7, i).getContents());
			kjjszjcjb2.setDh(sheet.getCell(8, i).getContents());
			kjjszjcjb2.setYx(sheet.getCell(9, i).getContents());
			kjjszjcjb2.setSfzh(sheet.getCell(10, i).getContents());
			kjjszjcjb2.setBz(sheet.getCell(11, i).getContents());
			kjjszjcjb2.setJlnf(sheet.getCell(12, i).getContents());
			kjjszjcjb2.setUsername(sheet.getCell(13, i).getContents());
			kjjszjcjb2.setGxsj(sheet.getCell(14, i).getContents());
			kjjszjcjb2.setSubmit(sheet.getCell(15, i).getContents());
	...
	public void showExportObject(String items) throws Exception {
		...
		String path = "D:\\计量管理专家表  admin " + time + ".xls";	

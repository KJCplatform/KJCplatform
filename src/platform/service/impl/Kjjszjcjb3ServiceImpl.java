...
public class Kjjszjcjb3ServiceImpl implements Kjjszjcjb3Service{
	...
	public void showImportObject(String filePath) throws Exception {
		...
		for (int i = 1; i < rows; i++) {
			...
			kjjszjcjb3.setZw(sheet.getCell(3, i).getContents());
			kjjszjcjb3.setJszc(sheet.getCell(4, i).getContents());
			kjjszjcjb3.setSszy(sheet.getCell(5, i).getContents());
			kjjszjcjb3.setYjfx(sheet.getCell(6, i).getContents());
			kjjszjcjb3.setSj(sheet.getCell(7, i).getContents());
			kjjszjcjb3.setDh(sheet.getCell(8, i).getContents());
			kjjszjcjb3.setYx(sheet.getCell(9, i).getContents());
			kjjszjcjb3.setSfzh(sheet.getCell(10, i).getContents());
			kjjszjcjb3.setBz(sheet.getCell(11, i).getContents());
			kjjszjcjb3.setJlnf(sheet.getCell(12, i).getContents());
			kjjszjcjb3.setUsername(sheet.getCell(13, i).getContents());
			kjjszjcjb3.setGxsj(sheet.getCell(14, i).getContents());
			kjjszjcjb3.setSubmit(sheet.getCell(15, i).getContents());

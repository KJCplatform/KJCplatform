...
public class KjcgcjbServiceImpl implements KjcgcjbService{
    ...
    public List<KjcgcjbForm> findKjcgcjbList(){
		...
		List<Kjcgcjb> list=this.kjcgcjbDao.findCollectionByConditionNoPage(hqlWhere, params, orderby);
    ...
    public List<KjcgcjbForm> findKjcgcjbListWithPage(int pagesize,int pageno,KjcgcjbForm kjcgcjbForm){
		...
		List<Kjcgcjb> list=this.kjcgcjbDao.findCollectionByConditionWithPage(hqlWhere, params, orderby,pagesize,pageno);
		List<KjcgcjbForm> formlist=this.KjcgcjbPOListToVOList(list);

if(pageno==1){

			this.listtemp =
					this.KjcgcjbPOListToVOList(this.kjcgcjbDao.findCollectionByConditionNoPage(hqlWhere, params, orderby));
			}
    ...
    public void updateKjcgcjb(KjcgcjbForm kjcgcjbForm,String username){
		...
		this.kjcgcjbDao.update(kjcgcjb);

	}
	@Override
    public void deleteObject(String id){
		this.kjcgcjbDao.deleteObjectByIDs(Integer.valueOf(id));
	}
	@Override
...
//				.findCollectionByConditionNoPage(hqlWhere, params, orderby);
	//	List<KjsjjljgxxbForm> formlist = this.KjsjjljgxxbPOListToVOList(list);
		...
		List<KjcgcjbForm> formlist =this.listtemp;

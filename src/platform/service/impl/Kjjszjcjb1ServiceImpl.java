...
public class Kjjszjcjb1ServiceImpl implements Kjjszjcjb1Service{
    ...
    public List<Kjjszjcjb1Form> findKjjszjcjb1List(){
		...
		List<Kjjszjcjb1> list=this.kjjszjcjb1Dao.findCollectionByConditionNoPage(hqlWhere, params, orderby);
    ...
    public List<Kjjszjcjb1Form> findKjjszjcjb1ListWithPage(int pagesize,int pageno,Kjjszjcjb1Form Kjjszjcjb1Form){
		...
		List<Kjjszjcjb1> list=this.kjjszjcjb1Dao.findCollectionByConditionWithPage(hqlWhere, params, orderby,pagesize,pageno);
		List<Kjjszjcjb1Form> formlist=this.Kjjszjcjb1POListToVOList(list);
		if(pageno == 1){
			this.formListTemp =
					this.Kjjszjcjb1POListToVOList(this.kjjszjcjb1Dao.findCollectionByConditionNoPage(hqlWhere, params, orderby));
		}
		return formlist;
    ...
    public void updateKjjszjcjb1(Kjjszjcjb1Form kjjszjcjb1Form,String username){
		...
		kjjszjcjb1.setJlnf(String.valueOf(Calendar.getInstance().get(Calendar.YEAR)));

...
public class Kjcgcjb implements java.io.Serializable{
	  private int id;
	  private String cgmc;
	  private String wcdw;
	  private String zywcr;
	  private Date wcsj;
	  private String djjdh;
	  private String txxs;
	  private String cgjj;
	  private String yyhy;
	  private String jsly;
	...
	public String getDjjdh() {
		return djjdh;
	}
	public void setDjjdh(String djjdh) {
		this.djjdh = djjdh;
	}
	...
	public void setFbrxz(int fbrxz) {
		this.fbrxz = fbrxz;
	}

...
public class Kjkjxmxxb implements java.io.Serializable {
	...
	public Set<Kjkjxmxxbcjdw> getKjkjxmxxbcjdws() {
		return kjkjxmxxbcjdws;
	}
	public void setKjkjxmxxbcjdws(Set<Kjkjxmxxbcjdw> kjkjxmxxbcjdws) {
		this.kjkjxmxxbcjdws = kjkjxmxxbcjdws;
	}

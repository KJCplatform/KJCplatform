...
public class KjgxqybabForm implements java.io.Serializable{
	 private String id;
	  private String year;
	  private String nf;
	  private String qymc;
	...
	public List<KjgxqybabzscqForm> getKjgxqybabzscqs() {
		return kjgxqybabzscqs;
	}
	public void setKjgxqybabzscqs(List<KjgxqybabzscqForm> kjgxqybabzscqs) {
		this.kjgxqybabzscqs = kjgxqybabzscqs;
	}
	public List<KjgxqybabyfxmForm> getKjgxqybabyfxms() {
		return kjgxqybabyfxms;
	}
	public void setKjgxqybabyfxms(List<KjgxqybabyfxmForm> kjgxqybabyfxms) {
		this.kjgxqybabyfxms = kjgxqybabyfxms;
	}
	public List<KjgxqybabgxcpForm> getKjgxqybabgxcps() {
		return kjgxqybabgxcps;
	}
	public void setKjgxqybabgxcps(List<KjgxqybabgxcpForm> kjgxqybabgxcps) {
		this.kjgxqybabgxcps = kjgxqybabgxcps;
	}

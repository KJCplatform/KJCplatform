...
public class KjndjpptkyxmbForm implements java.io.Serializable{
	  private String id;
	  private String xmbh;
	  private String xmmc;
	...
	public String getDwzjf() {
		return dwzjf;
	}
	public void setDwzjf(String dwzjf) {
		this.dwzjf = dwzjf;
	}
	public String getDwgbjf() {
		return dwgbjf;
	}
	public void setDwgbjf(String dwgbjf) {
		this.dwgbjf = dwgbjf;
	}
	public String getNdyjnr() {
		return ndyjnr;
	}
	public void setNdyjnr(String ndyjnr) {
		this.ndyjnr = ndyjnr;
	}
	public String getYjwcqk() {
		return yjwcqk;
	}
	public void setYjwcqk(String yjwcqk) {
		this.yjwcqk = yjwcqk;
	}
	...
	public String getClsfzj() {
		return clsfzj;
	}
	public void setClsfzj(String clsfzj) {
		this.clsfzj = clsfzj;
	}
	public String getQdcg() {
		return qdcg;
	}
	public void setQdcg(String qdcg) {
		this.qdcg = qdcg;
	}

...
function dealSave() {
	...
	var actionAdd = basePath + '/system/KjndjgkjjlqkbAction_add.action';
	var actionUpdate = basePath + '/system/KjndjgkjjlqkbAction_update.action';
...
function deleteDoc() {
	...
	$.messager.confirm('确认', '真的要删除选中的记录吗？', function(r) {
		if (r) {
			var actionPath = basePath + '/system/KjndjgkjjlqkbAction_delete.action?id=';
                 ...
                 $.messager.alert('提示','请选择上传文件！','info');
                  ...
                  if(d1==".xls"){
                    ...
                    //document.getElementById("questionTypesManage").submit();
                        ...
                        var showimport = basePath + '/system/KjndjgkjjlqkbAction_showimport.action';
...
function ShowExport(){
    ...
    var showimport = basePath + '/system/KjndjgkjjlqkbAction_showexport.action';

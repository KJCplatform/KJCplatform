...
//加载公文列表
function listDoc() {
	var actionPath = basePath + '/system/WqwqxkzxxAction_list.action';
	 $('#dg').datagrid({
            title : '武器装备科研生产许可信息表',
            //width : 1200,
            height: 400,
...
function dealSave() {
	...
	var actionAdd = basePath + '/system/WqwqxkzxxAction_add.action';
	var actionUpdate = basePath + '/system/WqwqxkzxxAction_update.action';
...
function deleteDoc() {
	...
	$.messager.confirm('确认', '真的要删除选中的记录吗？', function(r) {
		if (r) {
			var actionPath = basePath + '/system/WqwqxkzxxAction_delete.action?id=';
	             ...
	             $.messager.alert('提示','请选择上传文件！','info');   
	              ...
	              if(d1==".xls"){  
	            	...
	            	//document.getElementById("questionTypesManage").submit();     
	            		...
	            		var showimport = basePath + '/system/WqwqxkzxxAction_showimport.action';
...
function ShowExport(){
  ...
  { 
	...
	var showimport = basePath + '/system/WqwqxkzxxAction_showexport.action';

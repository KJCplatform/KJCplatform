...
//	$("#zgzs").val(doc.zgzs);
	...
	$("#dzrybl").val(doc.dzrybl);
	$("#yfrybl").val(doc.yfrybl);
	$("#jsnyfbl").val(doc.jsnyfbl);
	$("#jsnjnbl").val(doc.jsnjnbl);
	$("#jyngxsrbl").val(doc.jyngxsrbl);
	$("#zhdf").val(doc.zhdf);
	$("#zscqdf").val(doc.zscqdf);
	$("#zhnldf").val(doc.zhnldf);
	$("#glspdf").val(doc.glspdf);
...
function dealSave() {
	...
	var actionAdd = basePath + '/system/KjndgxjsqypjbAction_add.action';
	var actionUpdate = basePath + '/system/KjndgxjsqypjbAction_update.action';
...
function deleteDoc() {
	...
	$.messager.confirm('确认', '真的要删除选中的记录吗？', function(r) {
		if (r) {
			var actionPath = basePath + '/system/KjndgxjsqypjbAction_delete.action?id=';
	             ...
	             $.messager.alert('提示','请选择上传文件！','info');
	              ...
	              if(d1==".xls"){
	            	...
	            	//document.getElementById("questionTypesManage").submit();
	            		var params ="qymc="+fileName;
	            		var showimport = basePath + '/system/KjndgxjsqypjbAction_showimport.action';
...
function ShowExport(){
	...
	var showimport = basePath + '/system/KjndgxjsqypjbAction_showexport.action';

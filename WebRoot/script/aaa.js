...
//加载公文列表
function listDoc() {
	var actionPath = basePath + '/system/AaaAction_list.action';
	 $('#dg').datagrid({
            title : '大型仪器信息表',
            width : 1200,
            height: 400,
...
function dealSave() {
	...
	var actionAdd = basePath + '/system/AaaAction_add.action';
	var actionUpdate = basePath + '/system/AaaAction_update.action';

...
function dealSave() {
	...
	var actionAdd = basePath + '/system/KjgfjflqkAction_add.action';
	var actionUpdate = basePath + '/system/KjgfjflqkAction_update.action';
...
function deleteDoc() {
	...
	$.messager.confirm('确认', '真的要删除选中的记录吗？', function(r) {
		if (r) {
			var actionPath = basePath + '/system/KjgfjflqkAction_delete.action?id=';

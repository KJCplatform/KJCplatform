...
function dealSave() {
	...
	var actionAdd = basePath + '/system/KjndgxqybabAction_add.action';
	var actionUpdate = basePath + '/system/KjndgxqybabAction_update.action';
...
function deleteDoc() {
	...
	$.messager.confirm('确认', '真的要删除选中的记录吗？', function(r) {
		if (r) {
			var actionPath = basePath + '/system/KjndgxqybabAction_delete.action?id=';

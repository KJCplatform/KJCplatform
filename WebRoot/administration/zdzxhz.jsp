...
<head >
	...
	<script type="text/javascript" src="<%=basePath%>/script/zdzxhz.js"></script>
</head>
	...
	<div id="tabEdit2" style="overflow-y:auto;">
		<form id="frmEdit2" style="width:330px;margin:0px 0px 0px 0px"  method= "post">
		 ...
		 <br> <br>
			...
			<input name="Items" type="checkbox" checked="checked" value="3" />单位<br> 
			<input name="Items" type="checkbox" checked="checked" value="4" />项目名称<br> 
			<input name="Items" type="checkbox" checked="checked" value="5" />企业技术名称<br>
		</form>
	</div>
</div>		

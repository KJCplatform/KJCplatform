...
<script type="text/javascript" src="<%=basePath%>/script/kjndjpptkyxmb.js"></script>
		...
		<table id="dg">
			<thead>
				<tr>
					...
					<th field="dwzjf">到位总经费</th>
		
					<th field="dwgbjf">到位国拨经费</th>
					<th field="ndyjnr">年度研究内容</th>
					<th field="yjwcqk">研究内容完成情况</th>
					<th field="wwcyy">未按计划完成研究内容的原因</th>
					<th field="clsfzj">材料（产品）是否已实现装机应用</th>
					<th field="qdcg">取得的成果</th>
	...
	<div id="divEdit" style="display:none;">
		<div id="tabEdit" style="overflow-y:auto;">
			<form id="frmEdit"
				...
				<dl>
					...
					<dd>
						到位总经费: <input size="15" id="dwzjf" name="dwzjf" />
								...
								<dl>
					<dd>
						到位国拨经费: <input size="15" id="dwgbjf" name="dwgbjf" />
					</dd>
				</dl>
				...
				<dl>
					<dd>
						年度研究内容: <input size="15" id="ndyjnr" name="ndyjnr" />
					</dd>
				</dl>
				<dl>
					<dd>
						研究内容完成情况: <input size="15" id="yjwcqk" name="yjwcqk" />
					</dd>
				</dl>
				<dl>
					<dd>
						未按计划完成研究内容的原因: <input size="15" id="wwcyy" name="wwcyy" />
					</dd>
				</dl>
				<dl>
					<dd>
						材料（产品）是否已实现装机应用: <input size="15" id="clsfzj" name="clsfzj" />
					</dd>
				</dl>
								<dl>
					<dd>
						取得的成果: <input size="15" id="qdcg" name="qdcg" />
					</dd>
				</dl>
								<dl>
					<dd>
						存在的问题: <input size="15" id="czwt" name="czwt" />
					</dd>
				</dl>
				...
				<dl>
					<dd>
						存在问题拟采取的措施建议: <input size="15" id="csjy" name="csjy" />
					</dd>
				</dl>
				<dl>
					<dd>
